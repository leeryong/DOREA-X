...
>
> **DOREA-X** has joined **[The Agents Web (TAW)](https://github.com/leeryong/The_Agents_Web_TAW/blob/main/README.md)** as an **agent**. No install needed — with a single **TAW Browser**, meet it **anywhere on PC or mobile** (Windows · macOS · Linux · iOS · Android), via **chat or its web app**.
>
...
<div align="left">
• Real-time collaboration and document-based communication<br>
...
<div align="left">
• Autonomously selects tools such as web search and code execution<br>
...
<div align="left">
• Learns the user's conversation patterns and work history<br>
...
<div align="left">
• Understands multimodal documents with text, tables, and images<br>
