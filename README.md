...
> ### 🌐 이제 **TAW**에서 에이전트로 만나요!
>
> **DOREA-X** — 이제 **[The Agents Web (TAW)](https://github.com/leeryong/The_Agents_Web_TAW/blob/main/README.ko.md)** 플랫폼에서 **에이전트**로 만날 수 있습니다!
 ...
 **문서 이해부터 보고서 작성까지 전 과정을 지원하는 AI 에이전트**
...
<a href="https://youtu.be/_elzdn-ohUw?si=8glIDSEkReoY_qh1">
  ...
  ## 🌐 DOREA-X 배포판(DOREA-XP) 공개

  연구·교육·업무 현장에서 누구나 받아 직접 사용할 수 있도록 핵심 기능을 정리한 배포판을 공개했습니다.
