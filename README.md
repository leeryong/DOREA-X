...
> 연구와 업무 현장에서 즉시 활용 가능한 차세대 문서 이해 AI 에이전트
...
**DOREA-X**는 AI가 단순히 질문에 답하는 것에서 한 걸음 더 나아가, 문서를 함께 읽고, 정리하고, 대신 작성해주는 문서 기반 **AI 에이전트**입니다.  
보고서를 써야 하는데 막막할 때, 많은 양의 문서를 빠르게 파악해야 할 때, 여기저기 흩어진 정보를 한데 모아야 할 때 — DOREA-X가 옆에서 도와드리겠습니다.
...
### 🧠 맥락을 기억하는 에이전트
<img src="assets/logo2.jpg" alt="Memory" width="400"/>
...
- **같이 일하는 AI**: 명령을 따르는 도구가 아니라, 함께 생각하는 동료처럼 작동합니다.
